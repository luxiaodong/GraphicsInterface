...
namespace vkglTF
{
	...
	*/
	struct Texture {
		...
		void destroy();
		void fromglTfImage(tinygltf::Image& gltfimage, std::string path, VkQueue copyQueue);
	};
...
//		vkglTF::Texture* diffuseTexture;
	...
	*/
	...
	public:
		...
		void loadImages(tinygltf::Model& gltfModel, VkQueue transferQueue);
		void loadMaterials(tinygltf::Model& gltfModel);
		void loadAnimations(tinygltf::Model& gltfModel);
		void loadFromFile(std::string filename, VkQueue transferQueue, uint32_t fileLoadingFlags = vkglTF::FileLoadingFlags::None, float scale = 1.0f);
