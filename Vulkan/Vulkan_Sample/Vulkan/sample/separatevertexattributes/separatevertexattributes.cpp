...
#include "separatevertexattributes.h"

SeparateVertexAttributes::SeparateVertexAttributes(std::string title) : Application(title)
{
}

SeparateVertexAttributes::~SeparateVertexAttributes()
{}

void SeparateVertexAttributes::init()
{
    Application::init();
...
void SeparateVertexAttributes::initCamera()
{
...
void SeparateVertexAttributes::clear()
{
...
void SeparateVertexAttributes::prepareUniform()
{
...
void SeparateVertexAttributes::prepareDescriptorSetLayoutAndPipelineLayout()
{
...
void SeparateVertexAttributes::prepareDescriptorSetAndWrite()
{
...
void SeparateVertexAttributes::createGraphicsPipeline()
{
...
void SeparateVertexAttributes::updateRenderData()
{
}

void SeparateVertexAttributes::recordRenderCommand(const VkCommandBuffer commandBuffer)
{
