...
protected:
    ...
    VkDescriptorSet m_planeDescriptorSet;
    VkPipelineLayout m_planePipelineLayout;
    VkDescriptorSetLayout m_planeDescriptorSetLayout;
    VkBuffer m_planeUniformBuffer;
    VkDeviceMemory m_planeUniformMemory;
