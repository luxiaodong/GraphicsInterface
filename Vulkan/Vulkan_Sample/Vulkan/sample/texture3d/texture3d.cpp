...
Texture3Dim::Texture3Dim(std::string title) : Application(title)
{
}

Texture3Dim::~Texture3Dim()
{}

void Texture3Dim::init()
{
    Application::init();
...
void Texture3Dim::prepareVertex()
{
    ...
    m_pNoise = Noise::createNoise3D(128, 128, 128, m_graphicsQueue);
}

void Texture3Dim::prepareUniform()
{
...
void Texture3Dim::prepareDescriptorSetLayoutAndPipelineLayout()
{
...
void Texture3Dim::prepareDescriptorSetAndWrite()
{
    ...
    VkDescriptorImageInfo imageInfo = m_pNoise->getDescriptorImageInfo();
...
void Texture3Dim::createGraphicsPipeline()
{
    VkShaderModule vertModule = Tools::createShaderModule( Tools::getShaderPath() + "texture3d/texture3d.vert.spv");
    VkShaderModule fragModule = Tools::createShaderModule( Tools::getShaderPath() + "texture3d/texture3d.frag.spv");
