...
RenderHeadless::RenderHeadless(std::string title) : Application(title)
{
}
...
void RenderHeadless::run()
{
    init();
    clear();
}

void RenderHeadless::init()
{
//    Application::init();
    ...
    VkAttachmentDescription colorAttachmentDescription = Tools::getAttachmentDescription(m_colorFormat, VK_SAMPLE_COUNT_1_BIT, VK_ATTACHMENT_LOAD_OP_CLEAR, VK_ATTACHMENT_STORE_OP_STORE, VK_ATTACHMENT_LOAD_OP_DONT_CARE, VK_ATTACHMENT_STORE_OP_DONT_CARE, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL);
...
void RenderHeadless::createColorBuffer()
{
    Tools::createImageAndMemoryThenBind(m_colorFormat, m_swapchainExtent.width, m_swapchainExtent.height, 1, 1,
    ...
    Tools::createImageView(m_colorImage, m_colorFormat, VK_IMAGE_ASPECT_COLOR_BIT, 1, 1, m_colorImageView);
    
    VkCommandBuffer cmd = Tools::createCommandBuffer(VK_COMMAND_BUFFER_LEVEL_PRIMARY, true);
    Tools::setImageLayout(cmd, m_colorImage, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL, VK_PIPELINE_STAGE_ALL_COMMANDS_BIT, VK_PIPELINE_STAGE_ALL_COMMANDS_BIT, VK_IMAGE_ASPECT_COLOR_BIT);
    Tools::flushCommandBuffer(cmd, m_graphicsQueue, true);
}

void RenderHeadless::createFramebuffer()
{
...
void RenderHeadless::initCamera()
{
...
void RenderHeadless::prepareVertex()
{
...
void RenderHeadless::prepareUniform()
{
...
void RenderHeadless::prepareDescriptorSetLayoutAndPipelineLayout()
{
...
void RenderHeadless::prepareDescriptorSetAndWrite()
{
...
void RenderHeadless::createGraphicsPipeline()
{
...
void RenderHeadless::updateRenderData()
{
}

void RenderHeadless::renderToFile()
{
    ...
    this->recordRenderCommand(commandBuffer);
    vkCmdEndRenderPass(commandBuffer);
    
    Tools::setImageLayout(commandBuffer, m_colorImage, VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, VK_PIPELINE_STAGE_ALL_COMMANDS_BIT, VK_PIPELINE_STAGE_ALL_COMMANDS_BIT, VK_IMAGE_ASPECT_COLOR_BIT);
    
    Tools::flushCommandBuffer(commandBuffer, m_graphicsQueue, true);
    
    Tools::saveImage(m_colorImage, m_colorFormat, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, m_swapchainExtent.width, m_swapchainExtent.height, "screenshot.png");
}

void RenderHeadless::recordRenderCommand(const VkCommandBuffer commandBuffer)
{
