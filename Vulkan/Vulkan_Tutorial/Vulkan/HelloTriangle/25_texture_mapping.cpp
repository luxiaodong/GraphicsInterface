...
struct Vertex{
    ...
    static std::vector<VkVertexInputAttributeDescription> getAttributeDescriptions()
    {
        ...
        attribute3.location = 2;
        attribute3.binding = 0;
        attribute3.format = VK_FORMAT_R32G32_SFLOAT;
        attribute3.offset = offsetof(Vertex, texCoord);
        attributeDescriptions.push_back(attribute3);
...
//            }
    ...
    void createDescriptorSetLayout()
    {
        ...
        std::array<VkDescriptorSetLayoutBinding, 2> bindings = {vertexlayoutBinding, samplerLayoutBinding};
    ...
    {
        auto vertShaderCode = readFile("textures_vert.spv");
        auto fragShaderCode = readFile("textures_frag.spv");
